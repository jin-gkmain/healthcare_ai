...
const healthArticles: HealthArticle[] = [
  {
    ...
    category: "면역력",
    content:
      "추운 겨울철, 우리 몸의 면역력을 강화하여 감기와 독감을 예방하는 실용적인 방법들을 소개합니다. 충분한 수면, 규칙적인 운동, 균형 잡힌 영양 섭취가 핵심입니다.",
    readTime: "5분",
    tags: ["면역력", "겨울건강", "예방"],
    author: "Dr. 김건강",
  ...
  },
  {
    ...
    category: "근골격계",
    content:
      "현대인의 고질병인 거북목 증후군의 원인과 증상, 그리고 효과적인 예방법과 스트레칭 방법을 상세히 알아봅니다.",
    readTime: "7분",
    tags: ["거북목", "스트레칭", "현대병"],
    author: "Dr. 이바른",
  ...
  },
  {
    ...
    category: "순환기",
    content:
      "고혈압 예방과 관리를 위한 종합 가이드입니다. 생활습관 개선부터 약물 치료까지 체계적으로 설명합니다.",
    readTime: "10분",
    tags: ["혈압", "고혈압", "생활습관"],
    author: "Dr. 박혈관",
  ...
  },
  {
    ...
    category: "내분비",
    content:
      "당뇨병 환자들이 일상생활에서 혈당을 효과적으로 관리할 수 있는 실용적인 팁과 주의사항을 제공합니다.",
    readTime: "8분",
    tags: ["당뇨병", "혈당", "식단관리"],
    author: "Dr. 최당뇨",
...
const healthTips: HealthTip[] = [
  {
    ...
    tip: "하루 8잔의 물 마시기",
    description:
      "충분한 수분 섭취는 신진대사를 촉진하고 독소 배출에 도움이 됩니다.",
    icon: Apple,
  },
  {
    id: "2",
    ...
    tip: "계단 오르기 습관화",
    description:
      "엘리베이터 대신 계단을 이용하면 심폐기능 향상에 효과적입니다.",
    icon: Dumbbell,
  },
  {
    id: "3",
    ...
    tip: "규칙적인 수면 패턴 유지",
    description:
      "매일 같은 시간에 잠자리에 들고 일어나는 것이 건강한 수면의 기본입니다.",
    icon: Moon,
  },
  {
    id: "4",
    ...
    tip: "깊은 호흡 연습",
    description:
      "스트레스를 받을 때 4초 들이쉬고 4초 참고 4초 내쉬는 호흡법을 시도해보세요.",
    icon: Heart,
  },
];
          ...
          <Card className="border-green-200 bg-green-50">
            <CardContent className="p-4">
              ...
              <p className="text-sm text-green-700">
                매일 30분씩 햇볕을 쬐면 비타민 D 합성에 도움이 되어 뼈 건강과
                면역력 향상에 좋습니다.
              </p>
            </CardContent>
          </Card>
      ...
      <Card className="border-blue-200 bg-blue-50">
        <CardContent className="p-4">
          <p className="text-sm text-blue-800">
            📚 <strong>참고:</strong> 모든 건강 정보는 참고용이며, 개인의 건강
            상태에 따라 다를 수 있습니다. 구체적인 의학적 조언이 필요한 경우
            전문의와 상담하시기 바랍니다.
          </p>
        </CardContent>
      </Card>
