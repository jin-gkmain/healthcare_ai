...
import { Search, ChevronRight, AlertTriangle, CheckCircle, Info, Heart, Brain, Stethoscope, Activity, Clock, Star, RotateCcw, ArrowLeft, Zap, Target, TrendingUp, Users, MessageCircle, ArrowRight, Eye, Ear, User, Bone, Baby, RefreshCw } from 'lucide-react';
    ...
    commonSymptoms: [
      {
        ...
        relatedQuestions: ['스트레스가 많으신가요?', '잠을 충분히 주무셨나요?', '목과 어깨가 뻣뻣한가요?']
      },
      {
        id: 'dizziness',
        name: '어지럼증',
        ...
        relatedQuestions: ['갑자기 일어날 때 어지러우신가요?', '귀에 이상한 소리가 들리나요?']
      },
      {
        id: 'migraine',
        name: '편두통',
      ...
      },
      {
        ...
        relatedQuestions: ['최근에 스트레스가 많으셨나요?', '수면 패턴이 불규칙한가요?']
      },
      {
        id: 'anxiety',
        name: '불안감',
        ...
        relatedQuestions: ['심장이 빠르게 뛰나요?', '숨이 가빠지나요?', '땀이 많이 나나요?']
      },
      {
        id: 'depression',
        name: '우울감',
        ...
        relatedQuestions: ['잠들기 어려우신가요?', '식욕이 떨어졌나요?', '즐거웠던 일에 흥미를 잃으셨나요?']
      }
    ]
  },
  {
    ...
    commonSymptoms: [
      {
        ...
        relatedQuestions: ['한쪽 눈만 문제인가요?', '갑자기 시작되었나요?', '두통도 함께 있나요?']
      },
      {
        id: 'eye_pain',
        name: '눈 통증',
        ...
        relatedQuestions: ['컴퓨터를 오래 보셨나요?', '눈이 건조한 느낌인가요?']
      },
      {
        id: 'hearing_loss',
        name: '청력 저하',
        ...
        relatedQuestions: ['한쪽 귀만 문제인가요?', '귀에서 소리가 나나요?', '어지럼증도 있나요?']
      },
      {
        id: 'tinnitus',
        name: '이명',
      ...
      },
      {
        ...
        relatedQuestions: ['감기 기운이 있나요?', '알레르기가 있으신가요?', '콧물도 나나요?']
      },
      {
        id: 'sore_throat',
        name: '인후통',
        ...
        relatedQuestions: ['침 삼킬 때 아프신가요?', '목소리가 쉬셨나요?', '발열이 있나요?']
      },
      {
        id: 'hoarseness',
        name: '목소리 변화',
    ...
    commonSymptoms: [
      {
        ...
        relatedQuestions: ['운동할 때 더 아픈가요?', '숨쉬기 어려우신가요?', '팔이나 목으로 통증이 퍼지나요?']
      },
      {
        ...
        relatedQuestions: ['카페인을 많이 드셨나요?', '스트레스가 심한가요?', '어지럼증도 있나요?']
      },
      {
        id: 'swelling',
        name: '부종',
        ...
        relatedQuestions: ['아침에 심한가요?', '오래 서있으셨나요?', '신장 문제가 있으신가요?']
      },
      {
        ...
        relatedQuestions: ['두통이 있나요?', '목이 뻣뻣한가요?', '코피가 나나요?']
      },
      {
        id: 'cold_extremities',
        name: '수족냉증',
    ...
    commonSymptoms: [
      {
        ...
        severity: 'mild',
        keywords: ['기침', '해수', '기침소리'],
        relatedQuestions: ['가래가 나오나요?', '목이 아프신가요?', '발열이 있나요?']
      },
      {
        id: 'shortness_breath',
        name: '호흡곤란',
        ...
        relatedQuestions: ['평소보다 조금만 움직여도 숨이 차나요?', '밤에 숨이 차서 잠을 못 자나요?']
      },
      {
        id: 'wheezing',
        name: '천명음',
      ...
      },
      {
        ...
        relatedQuestions: ['스트레스나 불안감이 있으신가요?', '계단 오를 때 더 답답한가요?']
      }
    ]
  },
  {
    ...
    commonSymptoms: [
      {
        ...
        relatedQuestions: ['식사 후에 더 아픈가요?', '설사나 변비가 있나요?', '어느 부위가 가장 아픈가요?']
      },
      {
        id: 'nausea',
        name: '메스꺼움',
      ...
      },
      {
        ...
        severity: 'moderate',
        keywords: ['구토', '토함', '게움'],
        relatedQuestions: ['열이 있나요?', '복통도 있나요?', '물도 못 드시겠나요?']
      },
      {
        id: 'diarrhea',
        name: '설사',
        ...
        relatedQuestions: ['하루에 몇 번 정도 하시나요?', '혈변이 섞여 있나요?', '복통도 있나요?']
      },
      {
        id: 'constipation',
        name: '변비',
        ...
        relatedQuestions: ['며칠째 변을 못 보셨나요?', '배가 부른가요?', '가스가 안 나오나요?']
      },
      {
        id: 'indigestion',
        name: '소화불량',
        ...
        relatedQuestions: ['기름진 음식을 드셨나요?', '식사량이 평소보다 많았나요?']
      },
      {
        id: 'heartburn',
        name: '속쓰림',
        ...
        relatedQuestions: ['식사 후에 더 심한가요?', '신 것이 목으로 올라오나요?']
      }
    ]
  },
  {
    ...
    commonSymptoms: [
      {
        ...
        relatedQuestions: ['오래 앉아 있으셨나요?', '무거운 것을 들으셨나요?', '다리로 저린감이 있나요?']
      },
      {
        id: 'neck_pain',
        name: '목 통증',
        ...
        relatedQuestions: ['컴퓨터를 오래 하셨나요?', '베개가 높으신가요?', '어깨도 아프신가요?']
      },
      {
        id: 'shoulder_pain',
        name: '어깨 통증',
        ...
        relatedQuestions: ['팔을 들 때 아프신가요?', '오십견 진단을 받으신 적이 있나요?']
      },
      {
        id: 'joint_pain',
        name: '관절통',
        ...
        relatedQuestions: ['어느 관절이 아프신가요?', '부어있나요?', '아침에 뻣뻣한가요?']
      },
      {
        id: 'muscle_pain',
        name: '근육통',
        ...
        relatedQuestions: ['운동을 하셨나요?', '특정 부위가 아픈가요?', '마사지하면 나아지나요?']
      },
      {
        id: 'leg_cramps',
        name: '다리 경련',
        ...
        relatedQuestions: ['밤에 자주 일어나나요?', '운동 후에 생기나요?', '물을 충분히 드시나요?']
      }
    ]
  },
  {
    ...
    commonSymptoms: [
      {
        ...
        relatedQuestions: ['가려운가요?', '어디서 시작되었나요?', '새로운 제품을 사용하셨나요?']
      },
      {
        id: 'itching',
        name: '가려움',
        ...
        relatedQuestions: ['온몸이 가려운가요?', '발진도 있나요?', '특정 시간에 더 가려운가요?']
      },
      {
        id: 'dry_skin',
        name: '피부 건조',
      ...
      },
      {
        ...
        relatedQuestions: ['언제부터 시작되었나요?', '열감이 있나요?', '고름이 나오나요?']
      },
      {
        id: 'hair_loss',
        name: '탈모',
        ...
        relatedQuestions: ['가족력이 있나요?', '스트레스가 많으셨나요?', '특정 부위만 빠지나요?']
      },
      {
        id: 'acne',
        name: '여드름',
        ...
        relatedQuestions: ['청소년기인가요?', '스트레스를 받으시나요?', '화장품을 바꾸셨나요?']
      }
    ]
  },
  {
    ...
    commonSymptoms: [
      {
        ...
        relatedQuestions: ['하루에 몇 번 정도 가시나요?', '밤에도 자주 일어나시나요?', '아프신가요?']
      },
      {
        ...
        relatedQuestions: ['열이 있나요?', '혈뇨가 있나요?', '허리도 아프신가요?']
      },
      {
        id: 'blood_urine',
        name: '혈뇨',
        ...
        relatedQuestions: ['언제부터 시작되었나요?', '복통도 있나요?', '외상을 입으셨나요?']
      },
      {
        id: 'kidney_pain',
        name: '신장 부위 통증',
        ...
        relatedQuestions: ['열이 있나요?', '소변 색깔이 이상한가요?', '메스꺼움이 있나요?']
      },
      {
        id: 'genital_symptoms',
        name: '생식기 증상',
    ...
    commonSymptoms: [
      {
        ...
        relatedQuestions: ['체온을 재보셨나요?', '오한이 있나요?', '몸살기가 있나요?']
      },
      {
        id: 'chills',
        name: '오한',
      ...
      },
      {
        ...
        relatedQuestions: ['잠을 충분히 주무셨나요?', '최근에 스트레스가 많으셨나요?']
      },
      {
        id: 'weight_loss',
        name: '체중 감소',
        ...
        relatedQuestions: ['얼마나 빠지셨나요?', '식욕이 떨어졌나요?', '스트레스가 많으셨나요?']
      },
      {
        id: 'weight_gain',
        name: '체중 증가',
        ...
        relatedQuestions: ['식습관이 바뀌셨나요?', '운동량이 줄었나요?', '붓는 느낌도 있나요?']
      },
      {
        id: 'sleep_problems',
        name: '수면 장애',
        ...
        relatedQuestions: ['스트레스가 많으신가요?', '몇 시간 정도 주무시나요?', '중간에 자주 깨시나요?']
      },
      {
        id: 'night_sweats',
        name: '야간 발한',
        ...
        relatedQuestions: ['열도 있나요?', '체중이 변했나요?', '스트레스가 많으신가요?']
      }
    ]
  },
  {
    ...
    commonSymptoms: [
      {
        ...
        relatedQuestions: ['또래보다 많이 작나요?', '잘 먹나요?', '활동성은 어떤가요?']
      },
      {
        ...
        relatedQuestions: ['주기가 불규칙한가요?', '양이 많이 변했나요?', '통증이 심한가요?']
      },
      {
        id: 'morning_sickness',
        name: '입덧',
        ...
        relatedQuestions: ['임신 몇 주차인가요?', '물도 못 드시겠나요?', '체중이 줄었나요?']
      },
      {
        ...
        relatedQuestions: ['어떤 부분이 늦나요?', '또래와 비교해서 많이 다른가요?']
      },
      {
        id: 'feeding_problems',
        name: '수유/식이 문제',
        ...
        relatedQuestions: ['얼마나 안 먹나요?', '토하는 양이 많나요?', '체중이 늘지 않나요?']
      },
      {
        ...
        relatedQuestions: ['언제부터 시작되었나요?', '얼굴이 화끈거리나요?', '우울감도 있나요?']
      }
    ]
  }
];
...
const commonnessInfo = {
  ...
  moderate: { color: 'bg-purple-100 text-purple-800', label: '보통', percentage: 50 },
  rare: { color: 'bg-gray-100 text-gray-800', label: '드뭄', percentage: 20 }
};

export function SymptomChecker({ onNavigate, deviceInfo }: SymptomCheckerProps) {
    ...
    bodyParts.forEach(part => {
      part.commonSymptoms.forEach(symptom => {
        const isMatch = 
          ...
          (symptom.keywords && symptom.keywords.some(keyword => 
  ...
  const updateSymptomDetails = (symptomId: string, field: keyof SelectedSymptom, value: any) => {
  ...
  const handleAnalyze = async () => {
    ...
    // AI 분석 시뮬레이션
    setTimeout(() => {
      const urgentCount = selectedSymptoms.filter(s => s.severity === 'urgent').length;
      const concerningCount = selectedSymptoms.filter(s => s.severity === 'concerning').length;
      const avgIntensity = selectedSymptoms.reduce((sum, s) => sum + s.intensity, 0) / selectedSymptoms.length;
      ...
      const analysisData = {
        ...
        urgency: urgentCount > 0 ? 'immediate' : concerningCount > 0 ? 'soon' : 'routine'
      };
  ...
  const generateUserFriendlyRecommendations = (symptoms: SelectedSymptom[]) => {
    ...
    symptoms.forEach(symptom => {
      ...
      if (symptom.name.includes('복통') || symptom.name.includes('소화')) {
        recommendations.push('🥣 자극적인 음식을 피하고 소화가 잘 되는 음식을 드세요');
      }
      ...
      if (symptom.name.includes('피부') || symptom.name.includes('가려움')) {
        recommendations.push('🧴 자극적인 화장품 사용을 피하고 보습을 충분히 하세요');
      }
      if (symptom.name.includes('스트레스') || symptom.name.includes('불안')) {
        recommendations.push('🧘‍♀️ 명상이나 깊은 호흡으로 마음의 안정을 찾아보세요');
      }
    });
  ...
  const generatePossibleConditions = (symptoms: SelectedSymptom[]) => {
    ...
    if (symptomNames.includes('발열') && symptomNames.includes('기침')) {
      conditions.push({ name: '감기나 독감 가능성', probability: 'high', description: '바이러스 감염으로 보입니다' });
    }
    if (symptomNames.includes('두통') && symptomNames.includes('피로')) {
      conditions.push({ name: '스트레스나 수면 부족', probability: 'medium', description: '생활습관 개선이 도움될 수 있어요' });
    }
    if (symptomNames.includes('가슴') && symptomNames.includes('통증')) {
      conditions.push({ name: '심장 관련 검사 필요', probability: 'medium', description: '정확한 진단을 위해 병원 방문을 권합니다' });
    }
    if (symptomNames.includes('복통') && symptomNames.includes('메스꺼움')) {
      conditions.push({ name: '소화기 문제', probability: 'medium', description: '식단 조절과 충분한 휴식이 필요해요' });
    }
    if (symptomNames.includes('관절통') && symptomNames.includes('근육통')) {
      conditions.push({ name: '근골격계 문제', probability: 'medium', description: '물리치료나 재활운동이 도움될 수 있어요' });
    }
    if (symptomNames.includes('피부') && symptomNames.includes('가려움')) {
      conditions.push({ name: '알레르기나 피부 질환', probability: 'medium', description: '알레르기 테스트를 고려해보세요' });
    }
    if (symptomNames.includes('불안') && symptomNames.includes('우울')) {
      conditions.push({ name: '정신 건강 관리 필요', probability: 'medium', description: '상담이나 전문가 도움을 받아보세요' });
    }
      ...
      <div className="gradient-primary p-6 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            <Badge variant="outline" className="text-xs bg-green-500/20 text-primary-foreground border-green-500/30">
              10개 전문 분야
            </Badge>
            <Badge variant="outline" className="text-xs bg-purple-500/20 text-primary-foreground border-purple-500/30">
              {bodyParts.reduce((total, part) => total + part.commonSymptoms.length, 0)}개 증상
            </Badge>
          </div>
        </div>
      </div>
                ...
                <>
                  <div className="text-center mb-8">
                    ...
                    <p className={`text-muted-foreground ${
                      isMobile ? 'text-sm' : ''
                    }`}>SNOMED CT 기반 전문 분류로 정확한 진단을 도와드립니다</p>
                  </div>
                        ...
                        >
                          <CardContent className={`text-center ${
                            ...
                            <div className="mb-4 flex justify-center">
                              <div className={`gradient-primary rounded-3xl flex items-center justify-center group-hover:scale-110 transition-transform shadow-lg ${
                                isMobile ? 'w-16 h-16' : 'w-20 h-20'
                              }`}>
                                <span className={isMobile ? 'text-2xl' : 'text-3xl'}>{part.emoji}</span>
                              </div>
                            </div>
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    >
                      ...
                      <span className={isMobile ? 'text-xs' : ''}>다른 부위 선택</span>
                    </Button>
                    <div className="flex items-center gap-3">
                      <div className={`gradient-primary rounded-2xl flex items-center justify-center ${
                        isMobile ? 'w-10 h-10' : 'w-12 h-12'
                      }`}>
                        <span className={isMobile ? 'text-lg' : 'text-2xl'}>{selectedPart.emoji}</span>
                      </div>
                      <div>
                        <h2 className={`font-semibold ${
                          isMobile ? 'text-lg' : 'text-xl'
                        }`}>{selectedPart.name} 관련 증상</h2>
                        <p className={`text-muted-foreground ${
                          isMobile ? 'text-xs' : 'text-sm'
                        }`}>해당하는 증상을 모두 선택해주세요</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {selectedPart.commonSymptoms.map((symptom) => {
                      ...
                      const commonnessStyle = commonnessInfo[symptom.commonness];
                            ...
                            <div className="flex items-start justify-between mb-4">
                              <div className="flex-1">
                                <div className="flex items-center gap-3 mb-3">
                                  ...
                                  <span className={isMobile ? 'text-lg' : 'text-xl'}>{severityStyle.icon}</span>
                                </div>
                                <p className={`text-muted-foreground mb-4 ${
                                  isMobile ? 'text-sm' : ''
                                ...
                                <div className="flex flex-wrap gap-2 mb-4">
                                  ...
                                  <Badge className={commonnessStyle.color}>
                                    {commonnessStyle.label} ({commonnessStyle.percentage}% 경험)
                                  </Badge>
                            ...
                            {symptom.relatedQuestions && (
                              <div className="border-t pt-4">
                                ...
                                <div className="space-y-1">
                                  {symptom.relatedQuestions.map((question, index) => (
          ...
          <TabsContent value="search" className="flex-1 overflow-auto">
            <div className="space-y-6">
              <div className="text-center mb-6">
                ...
                <p className={`text-muted-foreground ${
                  isMobile ? 'text-sm' : ''
                }`}>예: 두통, 기침, 복통, 어지러움, 가슴답답함 등</p>
                <p className="text-xs text-muted-foreground mt-2">
                  💡 {bodyParts.reduce((total, part) => total + part.commonSymptoms.length, 0)}개 이상의 증상을 검색할 수 있습니다
                </p>
              </div>
              ...
              {searchQuery && (
                <div className="space-y-4">
                  <p className={`text-center text-muted-foreground ${
                    ...
                    "{searchQuery}"에 대한 검색 결과 ({searchSymptoms(searchQuery).length}개)
                  </p>
                  
                  {searchSymptoms(searchQuery).length === 0 ? (
                    <div className="text-center py-8">
                      <Search className="w-16 h-16 text-muted-foreground mx-auto mb-4" />
                      <p className="text-muted-foreground">검색된 증상이 없습니다</p>
                              ...
                              <div className="flex items-center justify-between">
                                <div className="flex-1">
                                  <div className="flex items-center gap-3 mb-2">
                                    ...
                                    {isSelected && <CheckCircle className="w-5 h-5 text-primary" />}
                                    <span className={isMobile ? 'text-base' : 'text-lg'}>{severityStyle.icon}</span>
                                  </div>
            ...
            <div className="space-y-6">
              {selectedSymptoms.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-xl font-semibold mb-2">선택된 증상이 없습니다</h3>
                  <p className="text-muted-foreground mb-6">먼저 증상을 선택해주세요</p>
                  <Button onClick={() => setActiveTab('select')} className="gradient-primary text-white">
                            ...
                            <div className="space-y-4">
                              ...
                              <div>
                                <Label className={`block mb-2 ${
                                  ...
                                  증상 정도: <span className="text-primary font-medium">{symptom.intensity}/10</span>
                                </Label>
                                <Slider
                                  value={[symptom.intensity]}
                                  onValueChange={([value]: number[]) => updateSymptomDetails(symptom.id, 'intensity', value)}
                                  max={10}
                                  min={1}
                                  step={1}
                                  className="w-full"
                              ...
                              <div>
                                ...
                                <div className={`grid gap-2 ${
                                  ...
                                  {['몇 시간', '1-2일', '3-7일', '1주일 이상'].map((duration) => (
                                    <Button
                                      key={duration}
                                      variant={symptom.duration === duration ? 'default' : 'outline'}
                                      size="sm"
                                      onClick={() => updateSymptomDetails(symptom.id, 'duration', duration)}
                                      className={`${
                              ...
                              <div>
                                ...
                                <div className={`grid gap-2 ${
                                  ...
                                  {['가끔', '자주', '계속'].map((frequency) => (
                                    <Button
                                      key={frequency}
                                      variant={symptom.frequency === frequency ? 'default' : 'outline'}
                                      size="sm"
                                      onClick={() => updateSymptomDetails(symptom.id, 'frequency', frequency)}
                                      className={`${
                                        isMobile ? 'text-xs py-2' : ''
                                      }`}
                                    >
                              ...
                              {symptom.relatedQuestions && (
                                <div className="bg-muted/30 p-4 rounded-lg">
                                  ...
                                  <div className="space-y-2">
                                    {symptom.relatedQuestions.map((question, qIndex) => (
                                      <div key={qIndex} className="flex items-start gap-3">
                                        <Checkbox id={`${symptom.id}-q${qIndex}`} />
                                        <Label 
                ...
                <Card className="border-glow">
                  <CardHeader>
                    <CardTitle className="flex items-center gap-3">
                      <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
                        analysisResult.riskLevel === 'urgent' ? 'bg-red-100 text-red-600' :
                        analysisResult.riskLevel === 'medium' ? 'bg-yellow-100 text-yellow-600' :
                  ...
                  <CardContent>
                    <div className="mb-4">
                      <Progress 
                        value={
                          analysisResult.riskLevel === 'urgent' ? 90 :
                          analysisResult.riskLevel === 'medium' ? 60 : 30
                        } 
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <Badge 
                        variant="outline"
                        className={
                          analysisResult.riskLevel === 'urgent' ? 'bg-red-100 text-red-800 border-red-200' :
                          analysisResult.riskLevel === 'medium' ? 'bg-yellow-100 text-yellow-800 border-yellow-200' :
                          'bg-green-100 text-green-800 border-green-200'
                        }
                      >
                        {analysisResult.riskLevel === 'urgent' ? '높음' :
                         analysisResult.riskLevel === 'medium' ? '보통' : '낮음'}
                      </Badge>
                      ...
                      {analysisResult.possibleConditions.map((condition: any, index: number) => (
                        <div key={index} className="border rounded-lg p-4">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            >
                              {condition.probability === 'high' ? '높음' :
                               condition.probability === 'medium' ? '보통' : '낮음'}
                            </Badge>
                          </div>
                          <p className={`text-muted-foreground ${
                            isMobile ? 'text-xs' : 'text-sm'
