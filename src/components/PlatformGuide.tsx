...
const features = [
  {
    ...
    description:
      "언제든지 건강 관련 질문을 하고 AI의 전문적인 답변을 받아보세요",
    features: [
      "24시간 실시간 상담",
      "의학적 근거 기반 답변",
      "개인 맞춤 건강 조언",
  ...
  },
  {
    ...
    description:
      "증상을 입력하여 가능한 질병을 예측하고 맞춤 조언을 받아보세요",
    features: [
      "SNOMED CT 표준 적용",
      "10개 전문 분야",
      "60개 이상 증상",
...
const faqs = [
  {
    ...
    answer:
      "의학 데이터베이스와 최신 연구를 기반으로 하지만, 참고용으로만 사용하시고 정확한 진단은 반드시 의료진과 상담하세요.",
  },
  {
    question: "개인정보는 안전한가요?",
    answer:
      "모든 상담 내용은 암호화되어 저장되며, 개인정보보호법에 따라 안전하게 관리됩니다.",
  },
  {
    question: "응급 상황에도 사용할 수 있나요?",
    answer:
      "응급 상황에는 119에 신고하시고, 본 서비스는 일반적인 건강 상담 목적으로만 사용해주세요.",
  },
  {
    question: "음성 상담이 안 되는 경우가 있나요?",
    answer:
      "브라우저 권한 설정이나 네트워크 상태를 확인해주세요. iOS Safari에서는 Chrome 앱 사용을 권장합니다.",
  },
];
...
export function PlatformGuide({ onNavigate, deviceInfo }: PlatformGuideProps) {
  ...
  return (
    <div className="h-full flex flex-col">
      <PageHeader
        title="사용 가이드"
        description="건강관리 AI 플랫폼의 모든 기능을 효과적으로 사용하는 방법을 알아보세요"
        icon={BookOpen}
        gradient="purple"
        badges={[
          { label: "완전 가이드", icon: Star, color: "green" },
          { label: "4개 기능", color: "blue" },
        ]}
      />

      <div className={`flex-1 overflow-auto ${isMobile ? "p-4" : "p-6 pb-24"}`}>
        <Tabs
          value={activeTab}
          ...
          <TabsContent value="overview" className="flex-1 overflow-auto">
            <div className="space-y-8">
              ...
              <div className="text-center mb-8">
                ...
                >
                  최신 AI 기술을 활용하여 24시간 건강 상담, 복약 관리, 질병 예측
                  등 종합적인 건강관리 서비스를 제공합니다.
                </p>
              </div>
          ...
          <TabsContent value="guide" className="flex-1 overflow-auto">
            <div className="space-y-6">
              ...
              <Card className="border-glow">
                <CardHeader
                  className={`bg-gradient-to-br ${selectedFeature.gradient} text-white rounded-t-lg`}
                >
                    ...
                    {selectedFeature.id === "voice" && (
                      <Alert>
                        ...
                        <AlertDescription>
                          ...
                          <br />• 모바일: 앱 진입 시 마이크 권한을 미리 허용하면
                          첫 질문부터 자동 음성 재생
                          <br />• iOS: Chrome 앱 사용 권장 (Safari는 음성 인식
                          제한)
                    ...
                    {selectedFeature.id === "symptoms" && (
                      <Alert>
                        ...
                        <AlertDescription>
                          ...
                          <br />• 여러 증상을 동시에 선택하여 종합적인 분석을
                          받으세요
                          <br />• 증상의 정도(1-10)와 지속 기간을 정확히
                          입력하세요
                          <br />• 결과는 참고용이며, 정확한 진단은 의료진과
                          상담하세요
                        </AlertDescription>
                      </Alert>
                    )}
              ...
              <div className="space-y-4">
                {faqs.map((faq, index) => (
                  <Card key={index} className="border-glow">
                    <CardContent className={isMobile ? "p-4" : "p-6"}>
                      <h4
                        className={`font-medium mb-3 text-primary ${
                          isMobile ? "text-sm" : ""
                        }`}
                      >
                  ...
                  {deviceInfo.isMobile ? (
                    <div className="space-y-3">
                      <div className="flex items-start gap-2">
                        ...
                        <p className="text-sm">
                          음성 상담 시 조용한 환경에서 사용하세요
                        </p>
                      </div>
                      <div className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-green-500 mt-0.5" />
                        <p className="text-sm">
                          권한 허용 후 더 편리한 기능을 이용할 수 있습니다
                        </p>
                      </div>
                      <div className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-green-500 mt-0.5" />
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-green-500 mt-0.5" />
                        <p className="text-sm">
                          키보드 단축키로 더 빠른 사용이 가능합니다
                        </p>
                      </div>
                      <div className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-green-500 mt-0.5" />
                        <p className="text-sm">
                          큰 화면으로 더 많은 정보를 한번에 확인할 수 있습니다
                        </p>
                      </div>
                      <div className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-green-500 mt-0.5" />
                        <p className="text-sm">
                          마우스와 키보드를 활용한 효율적인 입력이 가능합니다
                        </p>
                      </div>
                    </div>
                  )}
