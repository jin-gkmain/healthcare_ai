...
import { TrendingUp, Brain, Target, Award, Lightbulb } from "lucide-react";
      ...
      predictions: [
        {
          title: "수면 개선 예측",
          description:
            "현재 패턴을 유지하면 2주 후 수면 질이 15% 향상될 것으로 예측됩니다.",
          confidence: 85,
          icon: "🌙",
          color: "text-blue-500",
        },
        {
          title: "스트레스 관리",
          description:
            "주말 활동량 증가로 스트레스 레벨이 감소하는 추세입니다.",
          confidence: 78,
          icon: "🧘‍♀️",
        ...
        },
        {
          title: "건강 목표 달성",
          description:
            "현재 진행 속도로 이번 달 건강 목표를 95% 달성할 수 있습니다.",
          confidence: 92,
          icon: "🎯",
      ...
      recommendations: [
        {
          ...
          title: "수분 섭취 증가",
          description:
            "오늘 물 섭취량이 권장량의 60%입니다. 2시간마다 200ml씩 더 마셔보세요.",
        ...
        },
        {
          ...
          title: "운동 시간 조정",
          description:
            "저녁 운동보다 오전 운동이 당신의 생체리듬에 더 적합합니다.",
        ...
        },
        {
          ...
          title: "명상 시간 추가",
          description:
            "주 3회 10분 명상으로 스트레스를 더 효과적으로 관리할 수 있습니다.",
